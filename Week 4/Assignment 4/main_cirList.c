...
main_cirList.c: This file is used for testing the cirList.c file
*/
...
int main () {
    ...
    enqueue(q, -6);
    enqueue(q, 2);
    assertTrue(frontCirList(q->lst) == 8, "Testing frontCirList(q->lst) == 8 ");
    ...
    printf("-------------Testing peek-------------\n");
    assertTrue(peekQ(q) == 6, "Testing peekQ() == getFront(q)");
